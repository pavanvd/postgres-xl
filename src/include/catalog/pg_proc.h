...
#ifdef XCP
DATA(insert OID = 3203 ( stormdb_promote_standby	PGNSP PGUID 12 1 0 0 0 f f f t f v 0 0 2278 "" _null_ _null_ _null_ _null_ stormdb_promote_standby _null_ _null_ _null_ ));
